...
function drawHouse() {
  ...
  if (color1 != "brown" && color1 != "blue" && color1 != "green" && color1 != "orange" && color1 != "purple" && color1 != "red" && color1 != "yellow") {
    ...
    context.beginPath();
    context.fillStyle = "LightBlue";
    context.fillRect(canvas.width - 350, canvas.height - 125, 75, 75);
    context.strokeRect(canvas.width - 350, canvas.height - 125, 75, 75);
    context.closePath();
    lineWidth = 4;
    
    context.beginPath();
    context.fillStyle = "LightBlue";
    context.fillRect(canvas.width - 350, canvas.height / 3 + 75, 75, 75);
    context.strokeRect(canvas.width - 350, canvas.height / 3 + 75, 75, 75);
    context.closePath();
    lineWidth = 4;
    
    context.beginPath();
    context.fillStyle = color2;
    context.fillRect(canvas.width / 2 - 50, canvas.height - 160, 100, 150);
    context.strokeRect(canvas.width / 2 - 50, canvas.height - 160, 100, 150);
    context.closePath();
    lineWidth = 4;
    
    context.beginPath();
    context.fillStyle = "yellow";
    context.arc(canvas.width / 2 + 40, canvas.height - 85, 7, 0 * Math.PI, 2 * Math.PI);
    context.fill();
    context.stroke();
    lineWidth = 4;
  }
